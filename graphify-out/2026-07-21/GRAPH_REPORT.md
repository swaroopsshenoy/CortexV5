...
## Corpus Check
- 95 files · ~55,224 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 990 nodes · 1395 edges · 71 communities (64 shown, 7 thin omitted)
...
Cohesion: 0.08
Nodes (23): { app, BrowserWindow, ipcMain, dialog, shell }, { createAstAnalysisService }, { createAutoSaveService }, { createBenchmarkRunnerService }, { createClangService }, { createComparativeProfilingService }, { createExecutionSimulatorService }, { createNlpExplanationService } (+15 more)
...
### Community 68 - "createReportService"
Cohesion: 0.40
Nodes (5): createTerminalSession(), getReportService(), sendTerminalEvent(), toWorkspacePath(), createReportService()
...
- **Why does `createReportService()` connect `createReportService` to `Isolated Component 10`, `Isolated Component 11`, `stability.test.js`, `pipeline.test.js`?**
